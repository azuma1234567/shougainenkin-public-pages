...
発達障害当事者協会は、2024年度の不支給が約3万件で前年度から2倍以上に増えたと指摘する声明を出しています。協会独自のアンケートでは、回答者204名のうち19名(9.3%)が不支給。そしてもう一つ、注目すべき数字があります。「就労すると次回更新で等級が下がる、または支給停止になる」という話を聞いたことがあるかという問いに、**135名中105名(77.8%)が「ある」と回答**しました。
