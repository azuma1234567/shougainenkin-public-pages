...
新しく決まった障害年金の**70.3%が精神の障害**によるものです(令和6年度)。それだけ多くの人がこの書類を書いていて、同じところでつまずいています。この記事では、つまずきやすい場所を先に潰したうえで、期間別のフル記入例まで載せます。
...
**在職中の不調を我慢して、辞めてから初めて病院に行った人**が、いちばん大きな行き止まりに当たります。障害年金の種類は、**初診日にどの制度に加入していたか**で機械的に決まるからです。厚生年金に加入中の初診なら障害厚生年金(3級や障害手当金もあります)。退職後・国民年金期間の初診なら、**障害基礎年金だけ**(1級・2級のみ)になります。

ここで効くのが、申立書の最初の期間の書き方です。

- 在職中に、**内科でも**、不眠や食欲不振で受診した記録があれば、そこが初診日と認められる可能性があります(精神科である必要はありません)
- 転院時の**紹介状**は、初診日を示す強い資料になります。「紹介状をもらった記憶」を先に思い出してください
...
一方で、正反対の誤解にも注意してください。「正社員として働いている」「厚生年金を払っている」だけでは、不正ではありません。**国のガイドラインは、労働に従事していることをもって直ちに日常生活能力が向上したとは捉えない**としています。障害の状態が続いている限り、就労と受給は両立します。
...
書くのは、勤務の事実ではなく、**その内実**です。

- 職場で受けている**配慮**(業務の限定、免除されている仕事、勤務時間の短縮)
- **欠勤・早退・遅刻**の頻度。国のガイドラインも「精神障害による出勤状況への影響(頻回の欠勤・早退・遅刻など)を考慮する」としています
- 帰宅後・休日の状態。ガイドラインは「就労の影響により、就労以外の場面での日常生活能力が著しく低下していることが客観的に確認できる場合は、就労の場面及び就労以外の場面の両方の状況を考慮する」としています

**就労継続支援A型・B型、就労移行支援、障害者雇用制度**で働いている場合、ガイドラインは**1級または2級の可能性を検討する**と明記しています。一般企業でも、同程度の援助を受けて働いているなら**2級の可能性を検討する**とされています。
...
紹介状などの医療機関間の書類で初診日が確定するケースは多くあります。詳しくは[初診日がわからないときの調べ方](/columns/shoshinbi-wakaranai)へ。
