...
この記事では、Xで障害年金についての発信を長く続けている2人——社労士事務所で働きながら、自身も障害年金の当事者として制度を経験してきた「障害年金の呟き人」さん(@f1c3n4WE1KMklqQ)と、精神障害2級の当事者であり税理士(国税OB)・社労士資格も持つ「岸野さん」(@coco_ruuchan)——の発信を読み込み、そこから見えてくる「申立書で本当に差がつくポイント」を、期間別のフル記入例つきで解説する。制度の一般論ではなく、**当事者と実務者が繰り返し警告していることから逆算した書き方**だ。
...
初診日の調べ方自体は[初診日がわからないときの調べ方](/columns/shoshinbi-wakaranai)で詳しく書いたが、申立書との関係で覚えておくべきは一つ。**申立書の1つ目の期間は、初診日の証明と整合していなければならない。** ここが食い違うと、書類全体の信頼が揺らぐ。
...
そしてこの実態は、申立書だけに書いても片手落ちになる。**診断書の就労欄に同じ実態が載っていないと、書類間で温度差が出る**からだ。診断書側で何をどう伝えるかは[医師に伝えること全リスト](/columns/shindansho-ishi-ni-tsutaeru)にまとめてある。申立書と診断書が同じ生活を描いている状態が、審査で最も強い。
...
**ポイント:** ここが申立書全体で一番大事な枠になることが多い。「通わなかった=良くなった」と読まれないよう、**通えなかった理由**と**その間の生活の実態**を具体的に書く。
...
なお、家族から見た様子を書き添えることにも意味がある。呟き人さんは(永久認定の文脈でだが)**家族や支援者による日常生活状況の具体的なメモ、いわゆる第三者記述が、書類の整合性の裏付けになる**という趣旨の発信をしている。アキさんの例で言えば「母から見た一日」のメモは、申立書の記述を裏から支える材料になる。
