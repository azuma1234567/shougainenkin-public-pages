...
- **学生時代の学生納付特例を、親が出していました。** 本人はまったく知りません。仕送りと一緒に手続きも済んでいた、というのがいちばん多い形
- **失業したときに市役所で免除申請を出していました。** 離職票を持って手続きに行ったときに、まとめて出していたことを忘れている
- **生活保護を受けていた期間の法定免除。** 届出があれば自動的に免除になっているので、本人は「払っていない」としか記憶していない
- **出産前後の産前産後免除。** 自動では適用されないが、届出済みなのを忘れているケースがある
- **配偶者の扶養に入っていた期間が第3号でした。** そもそも保険料を納める必要がなかった期間なので、「払っていない期間」と記憶が混ざる
- **短期間の勤務でも厚生年金に入っていました。** 数か月のアルバイトでも、要件を満たしていれば厚生年金の被保険者期間になります。この期間は納付済みと同じ扱いになる
...
- **ねんきんネット**……24時間確認できます。月ごとの納付状況が見られる
- **ねんきんダイヤル**……電話で確認できる
- **年金事務所の窓口**……ここが本命
...
**② 社会的治癒**
症状が安定して特段の治療が必要なく、通常の社会生活を送れていた期間が一定以上続いていた場合、その後の再受診日を新しい初診日として扱える考え方です。目安はおおむね5年とされるが、5年未満で認められた例も、5年以上で否定された例もあります。**納付要件を満たせないケースは、社会的治癒を主張すべき筆頭にあたります。** 立証には、当時の給与明細、健康保険の資格記録、健康診断の結果、資格取得の記録など「生活に支障がなかった」と読める客観資料を揃えます。

**③ 20歳前傷病として構成できないか**
20歳前に受診歴がなかったか、もう一度洗い直します。

**④ 特別障害給付金**
納付要件不足に対する最後の受け皿として、この制度があります。対象は限られていて、平成3年3月以前に任意加入対象だった昼間部の学生、昭和61年3月以前に任意加入対象だった被用者等の配偶者で、当該期間に初診日がある人です。**請求窓口は年金事務所ではなく市区役所・町村役場**で、65歳に達する日の前日までに請求する必要があります。金額は障害基礎年金より低いが、ゼロではありません。

**⑤ 記録訂正**
本当は3号だったのに1号未納として記録されている、事業主が厚生年金の資格取得届を出していなかった——といったケースを疑い、記録訂正を請求します。訂正が通れば未納が消えます。なお、厚生年金の資格取得届が初診日以後に提出された場合、届出の前々月まで遡って2年間が当初から納付済期間として扱われます。これは「後出し」ではなく記録の是正なので、納付要件に効きます。
...
- 要件は「3分の2」か「直近1年」のどちらかを満たせばよいです。多くの人が救われるのは直近1年のほう
- 直近1年の特例は、令和18年3月末まで10年延長されました。古い情報で諦めない
- 判定は初診日の**前日**時点。後から納めても、後から免除申請しても、間に合わない
- 払えないときは未納で放置せず、免除・猶予を申請しておきます。これが唯一の事前防御
- 免除・学生納付特例・猶予は未納ではありません。ただし一部免除は減額後の保険料を納めていないと未納
- 3号不整合と海外居住期間は、記録を取ってはじめてわかります。自己判断しない
- 初診日が1か月ずれると判定の窓もずれます。証明書を取る前に、候補日ごとに確認する
