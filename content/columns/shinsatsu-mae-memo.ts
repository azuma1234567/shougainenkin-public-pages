...
この記事では、診察室の外の生活を診断書に反映させるための現実的な方法——**診察前メモ**を解説します。A4一枚の完成形も載せます。
...
精神の障害用の診断書には「**日常生活能力の判定**」という7項目の欄があります。食事、身辺の清潔保持、金銭管理と買い物、通院と服薬、対人関係、危機対応、社会性。この7項目の**平均**と「**日常生活能力の程度**」の組み合わせで、国が公表している**障害等級の目安**が決まります。

そして厚生労働省の記載要領では、**この7項目は本人や家族からの聴き取りをもとに記載する**とされています。**つまり、あなたが伝えなければ埋まらない欄です。**

精神の障害で不支給になった事案の**75.3%**は、この目安表で下位の区分にあたるものでした。**診察室の数分で何が伝わるかが、そのまま結果に効きます。**大げさな話ではなく、これが構造です。

医師が悪いのでも、あなたの伝え方が下手なのでもありません。**数分の診察でこの7項目の実態が伝わるほうがおかしい**のです。だから紙にします。
