...
実はこのルール、当事者だけでなく**医師も見落とすことがあります**。医師向けの記載要領にはさらに踏み込んで、家族との同居や施設入所などで「支援が常態化した環境下で日常生活が安定している場合であっても、単身でかつ支援がない状態で生活した場合を想定して」記載するよう明記されています。
...
そしてこのすれ違いは、取り返すのが難しい。一度不支給になって2度目の申請をすると、審査側には**前回の内容が申し送りされた調書が作られ、前回との比較が厳格に行われる**ため、難易度が格段に上がります。
