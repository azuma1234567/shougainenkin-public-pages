...
export const HUBS: HubDefinition[] = [
  ...
  hub("/yougo", "障害年金の用語辞典", "用語辞典", "existing", true),
  hub("/gokai", "障害年金のよくある誤解", "よくある誤解", "existing", true, ["techou-to-nenkin"]),
  ...
  hub("/byoki/jinzou-touseki", "腎臓病・人工透析", "腎臓病・人工透析", "byoki", true, [], "傷病=腎"),
  ...
  hub("/byoki/ninchishou", "認知症(若年性を含む)", "認知症", "byoki", true),
  hub("/byoki/koujinou", "高次脳機能障害", "高次脳機能障害", "byoki", true, [], "傷病=高次脳機能障害"),
  hub("/byoki/izon", "依存症", "依存症", "byoki", true, [], "傷病=依存症"),
  hub("/byoki/kanzou", "肝臓の病気", "肝臓", "byoki", true),
  hub("/byoki/kokyuuki", "呼吸器の病気", "呼吸器", "byoki", true, [], "傷病=呼吸器"),
  hub("/byoki/ketsueki", "血液・造血器の病気", "血液・造血器", "byoki", true, [], "傷病=血液"),
  hub("/byoki/shikaku", "目の障害", "目", "byoki", true, [], "傷病=眼"),
...
export const COLUMN_HUB_ASSIGNMENTS: Record<string, ColumnHubAssignment> = {
  ...
  "hikazei-shuunyuu": assignment("/okane/ikura", "core", ["/jukyuugo/okane", "/joukyou/seikatsu-hogo", "/okane/zeikin"]),
  "jukyuugo-tetsuduki": assignment("/nayami/koushin", "leaf", ["/shinsei#step-8", "/jukyuugo/okane"]),
  "taishou-shoubyou-kyoukai": assignment("/byoki/tekiou-fuan", "promote", ["/gokai", "/byoki/tenkan", "/byoki/izon"], "tekio-shogai-shogai-nenkin"),
  ...
  "ikura-moraeru": assignment("/okane/ikura", "promote", ["/shinsei", "/joukyou/seikatsu-hogo", "/okane/zeikin"]),
  "sokyuu-seikyuu": assignment("/nayami/sokyuu", "promote", ["/okane/ikura"], "ninteibi-jigojusho"),
  "kiso-kousei-chigai": assignment("/shinsei#step-1", "core", ["/okane/ikura", "/joukyou/shufu-mushoku"]),
  "hatachi-mae": assignment("/joukyou/hatachi-mae", "promote", ["/shinsei#step-3", "/jukyuugo/sagyousho", "/joukyou/gakusei"]),
  ...
  "nofu-yoken": assignment("/shinsei#step-3", "core", ["/joukyou/hatachi-mae", "/joukyou/gakusei", "/joukyou/shufu-mushoku"]),
  "shinsei-shindoi": assignment("/shinsei", "core", ["/hajimete"]),
  "nenkin-jimusho-soudan": assignment("/shinsei#step-4", "core", ["/erabu/jibun-ka-irai", "/joukyou/kazoku-ga-tetsudau", "/erabu/irai-subeki-case"]),
  "jibun-de-shinsei": assignment("/erabu/jibun-ka-irai", "promote", ["/shinsei", "/erabu/irai-subeki-case"]),
  "sharoushi-kawaranai-koto": assignment("/erabu/jibun-ka-irai", "promote", ["/erabu/irai-subeki-case", "/nayami/shindansho-komatta"]),
  ...
  "tokyu-hantei-guideline": assignment("/byoki/utsu-soukyoku", "core", ["/shinsei#step-5", "/byoki/tougou"]),
  "shindansho-jittai-chigau": assignment("/nayami/shindansho-komatta", "core"),
  "moushitatesho-kakikata": assignment("/shinsei#step-6", "core", ["/byoki/utsu-soukyoku", "/joukyou/kazoku-ga-tetsudau"]),
