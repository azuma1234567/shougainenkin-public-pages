...
/* dateModified はハブの最終更新日(YYYY-MM-DD)。sitemap の lastModified と
   ...
   metaDescription も任意。meta description・og:description・Article.description に使う。本文の1行目が短い(80 字未満)
   ハブだけに持たせる。h1 や本文には出さない(docs/seo-aio-2026-09-23-instructions.md §2)。 */
export type HubContent = { title: string; metaTitle?: string; metaDescription?: string; dateModified: string; breadcrumb: string[]; source: string };
