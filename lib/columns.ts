...
const BASE_COLUMNS: Omit<Column, "hubPrimary" | "hubSecondary" | "role" | "mergeCandidate">[] = [
  ...
  },
  {
    ...
    description:
      "障害年金の更新（障害状態確認届）は1〜5年ごと。提出期限、就労中の注意点、支給停止や級落ちへの備えを解説します。令和6年度の再認定304,456件のうち96.7%はそのまま継続、支給停止は1.1%（日本年金機構「障害年金業務統計」）。",
    datePublished: "2026-07-20",
    dateModified: "2026-08-27",
    primaryCluster: "application",
    secondaryClusters: ["medical-certificate"],
  ...
  },
  {
    ...
    description:
      "障害厚生年金3級は「労働に著しい制限がある」等級で、働くことと両立します。最低保障額は令和8年度で年635,475円(月約53,000円)。基礎年金に3級はありません。更新で「配慮なしに働けている」と読まれると非該当、悪化したら額改定請求で2級、非該当でも3年・65歳までは受給権が残る。給付金・法定免除の対象外など3級だけの扱いも一覧に。",
    datePublished: "2026-09-13",
    dateModified: "2026-09-13",
    primaryCluster: "application",
    category: "受給が始まってから",
  ...
  },
  {
    ...
    description:
      "B型の平均工賃は月24,141円(令和6年度・全国)、A型の平均賃金は91,451円。障害基礎年金2級は月70,608円(令和8年度)。B型+2級で約95,000円、A型+2級で約162,000円。引かれる利用料(課税世帯で上限9,300円)・交通費・GHの家賃、足される給付金(2級 月5,620円)・家賃補助・手当、生活保護との併用の仕組み、見学で聞くお金の8項目。",
    datePublished: "2026-09-13",
    dateModified: "2026-09-13",
    primaryCluster: "application",
    category: "受給が始まってから",
