...
export const COLUMNS: Column[] = [
  ...
  },
  {
    ...
    metaTitle:
      "初めて年金事務所へ障害年金の相談に行く方へ｜予約・持ち物・質問",
    description:
      "障害年金の相談で年金事務所に行く前に読む記事。予約方法(ネット・専用電話)、相談で必ず聞かれる5つのこと、こちらから聞くべき7つの質問、持ち物リストの完成形、相談前に初診日を調べておくべき理由、窓口で「無理」と言われたときの受け止め方、家族だけで行く方法、行けないときの代替手段まで。",
  ...
  },
  {
    ...
    metaTitle:
      "受診状況等証明書のもらい方｜費用・頼み方・取れない場合",
    description:
      "障害年金の受診状況等証明書(初診日の証明)の取得方法を徹底解説。診断書との違い、不要なケース、電話での依頼台本、費用と期間の目安、受け取ったら確認する5項目、カルテ廃棄・廃院で取れないときの2番目の病院ルートと「添付できない申立書」、第三者証明や参考資料の集め方まで。",
    datePublished: "2026-07-23",
    dateModified: "2026-07-23",
  },
  {
  ...
  },
  {
    ...
    metaTitle:
      "障害年金は申請から結果まで何か月?｜審査・初回振込",
    description:
      "障害年金の申請から結果・入金までにかかる期間を段階別に解説。準備2〜3か月+審査3〜4か月+年金証書から初回振込まで約50日で、トータル半年前後。サービススタンダード、審査が長引く原因、審査中の分もさかのぼって支払われる仕組み、待つ間にやるべき5つのこと、遅いときの問い合わせ方まで。",
    datePublished: "2026-07-23",
    dateModified: "2026-07-23",
  },
  {
    ...
    description:
      "病歴・就労状況等申立書の期間の区切り方を徹底解説。医療機関ごと・未受診期間・3〜5年ごとの3原則、同じ病院に長く通っている場合の分け方、転院が多い・記憶が曖昧なときの区切り方、続紙の使い方、期間一覧の完成形、よくある質問まで。",
  ...
  },
  {
    ...
    title:
      "障害年金の初診日がわからないときに確認する5つの方法 — カルテ破棄・廃院・記憶なしでも証明を組み立てる手順",
    metaTitle: "障害年金の初診日がわからないときに確認する5つの方法",
    description:
      "障害年金の初診日がわからない・証明できないときの5つの方法を解説。受診状況等証明書の取り方、カルテ破棄や廃院のときの参考資料、受診状況等証明書が添付できない申立書、第三者証明のルール、医療従事者の証明の強さ、初診日を間違えやすいケース、よくある質問まで。",
    datePublished: "2026-07-17",
    dateModified: "2026-07-26",
  },
  {
