...
---
<!-- 変更: 結論の箱 / 文中太字を外し「(1)〜(3)」「待ち時間①〜④」「(1)〜(5)」を h3 に / 道具(kingaku・madoguchi) / 誤解(jikou-de-muri) / 裁決2件(h30_r01-16_02・r04_05-06_02) / 「初回の振込までさらに1〜2か月」「医師の作成期間(2週間〜1か月)」「予約だけで1か月先」「2度目は前回内容と厳格に比較され難易度が格段に上がる」を削除 / 「このページで分かること」は結論の箱に統合 / 期間の数字はサービススタンダードと法令上の日付のみ -->
...
- 医療機関の書類作成期間 — [受診状況等証明書](/columns/jushinjokyo-shomeisho)や[診断書](/columns/shindansho-irai-timing)の作成にどのくらいかかるかは、病院によって異なります。依頼するときに日数を聞いてください
...
時間が読めないもの(過去の病院への依頼)を先に、期限があるもの(診断書)を後に。この順番を崩すと、診断書の現症日が切れて取り直しになります(→[必要書類の記事](/columns/hitsuyou-shorui-seishin))。
...
- 問い合わせ先: 提出した年金事務所、またはねんきんダイヤル(0570-05-1165)
...
2. 通知の日付 — 不服申立て(審査請求)の期限は、決定を知った日の翌日から3か月。ここから数えます
...
自分がどの類型かは、[年金事務所の初回相談](/columns/nenkin-jimusho-soudan)で障害認定日を確認すれば分かります。「急ぐべきか、質を優先すべきか」の判断は、ここが分岐点になります。1か月分がいくらに当たるかは、自分の条件で計算できます(令和8年度の障害基礎年金2級は年847,300円、月およそ70,600円です)。

→ いくらもらえる?(/dougu/kingaku)

### 20歳前傷病の場合の追加ステップ

[20歳前傷病による障害基礎年金](/columns/hatachi-mae)を請求する人は、通常の流れに加えて所得の確認が入ります。この類型は保険料を納めずに受給できる代わりに、本人の前年所得による支給制限があるためです。
...
**統合失調症・事後重症請求(平成30〜令和元年、h30_r01-16_02)** — 事後重症による障害基礎年金の支給開始は裁定請求月の翌月であり、制度施行時までさかのぼって支給することはできないとして、遡及支給を求める再審査請求が棄却されました。事後重症は「請求した月の翌月分から」が動かない、ということです。

**時効(令和4〜5年、r04_05-06_02)** — 裁定前であっても、各回の支払いを受ける権利の消滅時効は支払期が来た時から進行するとの最高裁判決を引用し、5年より前の分を不支給とした処分が適法とされました。「決定が遅れたから時効も止まる」わけではない、という例です。
...
- [傷病手当金](/columns/shoubyou-teatekin)(健康保険): 休職中なら、最長1年6か月・給与のおよそ3分の2。病名の対象外ルールは障害年金の話であって、傷病手当金には関係ありません
...
- 「次回診断書提出年月」を確認する。ここに書かれた時期が、次の[更新(障害状態確認届)](/columns/koushin-kakuninhodo)の目安です。今すぐスマートフォンのカレンダーに入れておくことをおすすめします。数年後にこれを見落として提出が遅れると、支払いが一時止まることがあります(後から提出すればさかのぼって支払われますが、家計には響きます)
...
A. 2026年9月13日時点で、ねんきんネットの機能一覧(年金見込額・年金記録・電子版ねんきん定期便・各種通知・届書の電子申請・持ち主不明記録の検索)に、障害年金の請求の審査状況を確認する機能はありません。審査の状況を知りたいときは、提出した年金事務所か、ねんきんダイヤル(0570-05-1165)に電話して、基礎年金番号と提出日を伝えて聞いてください。

**Q. 周りの人より遅い気がします。自分だけ遅いのは不支給のサインですか?**
A. 違います。期間は人によって幅があり、初診日の照会や記載内容の確認が入ると長くなります。年間45万件を超える診査を一か所(障害年金センター)で行っているため、順番待ちも起きます。遅いこと自体は結果と関係ありません。3か月を過ぎたら、上の窓口で状況を確認してください。
...
- 結果が遅いときは、年金事務所やねんきんダイヤル(0570-05-1165)で状況を確認できる
...
- [日本年金機構「ねんきんネット」](https://www.nenkin.go.jp/denshibenri_kojin/n_net/index.html)(機能一覧: 年金見込額・年金記録・電子版ねんきん定期便・各種通知・届書の電子申請・持ち主不明記録の検索)・確認日 2026-09-13
- [日本年金機構「ねんきんダイヤル」](https://www.nenkin.go.jp/section/tel/toiawase_ippan.html)(0570-05-1165、050で始まる電話などからは03-6700-1165)・確認日 2026-09-13
