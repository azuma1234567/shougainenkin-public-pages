...
lead:
  - 病歴・就労状況等申立書は、審査する人が唯一読む「あなたの言葉」です。「どれだけつらかったか」ではなく、「生活の何が、どのくらいの頻度でできなかったか」を書きます。各期間は ①頻度 ②続いた期間 ③受けていた援助 ④できなかったことの具体例 の4要素で。
  - 書き始める前に初診日を確認してください。退職後に初めて受診した人は障害基礎年金だけになります。在職中に内科で不眠を診てもらった記録があれば、そこが初診日になることがあります。
  - 就労欄は「在籍の事実」ではなく実態を書きます。欠勤・早退の頻度、受けていた配慮、辞めた理由まで。国のガイドラインは「働いていることをもって直ちに日常生活能力が向上したとは捉えない」としています。
  - 受診しなかった期間を空白にしないでください。「良くなって通院をやめた」と読まれます。盛るのは逆効果で、診断書と食い違えば診断書が信じられます。
---
<!-- 変更: 結論の箱 / 文中太字を外し「期間1〜4」等を h3 に / 道具(moushitatesho・mitate)・誤解2枚・裁決2件 / 「実務者が明言」「実務者は警告」「紹介状で確定するケースは多く」「繰り返し語られる」を削除または裁決IDに -->

## 「一番つらかった話」を書いても、伝わらない

アキさん(32歳。この記事のための架空の例です)は、うつ病で会社を辞めて2年になります。実家で母と暮らしながら、障害年金の申請を決めました。
...
期間を区切って、順番に書き進められる機能を用意しました。入力した内容はどこにも送られません。
...
- 転院時の紹介状は、初診日を示す強い資料になります。医師の診療情報提供書から初診日が認定された裁決もあります(r04_05-06_06)。「紹介状をもらった記憶」を先に思い出してください
...
そしてこの実態は、申立書だけに書いても片手落ちになります。診断書の就労欄に同じ実態が載っていないと、書類間で温度差が出るからです。診断書側で何をどう伝えるかは[医師に伝えること全リスト](/columns/shindansho-ishi-ni-tsutaeru)にまとめてあります。申立書と診断書が同じ生活を描いている状態が、審査で最も強いです。

## 同じ状況の人が、どうなったか

社会保険審査会の裁決から、就労の実態がどう見られたかの実例です。原文は厚生労働省の公開資料で確認しています。

**うつ病・障害認定日請求(平成28〜29年、h28_29-07_09)** — 家族の援助を要する日常生活能力と、就労支援での短時間作業も続かなかった経過を総合して、障害認定日に2級に該当するとし、3級とした原処分が取り消されました。「働いていた」ではなく「短時間作業も続かなかった」まで書類に載っていたことが効いた例です。

**非定型うつ病・障害認定日請求(平成30〜令和元年、h30_r01-07_01)** — 障害認定日には職場の配慮を受けつつ一般雇用で管理職として週4日勤務し、日常生活能力も比較的保たれていたため、3級にも該当しないとされました。就労の中身によっては届かない、という正直な例です。どちらの例も、見られているのは「在籍の事実」ではなく「どんな援助の中で、どこまで働けていたか」です。
...
なお、診断書の裏面には「日常生活能力の判定」という欄があり、食事・清潔保持・金銭管理と買い物・通院と服薬・対人関係・危機対応・社会性の7項目で評価されます。申立書でも同じ場面を具体的に書いておくと、診断書と申立書が同じ生活を別角度から描くことになり、「書類の整合性」がここで確保されます。この7項目が国の目安表でどのあたりに当たるかは、[私は何級くらい?](/dougu/mitate)で確かめられます。
...
ただし、当事者の側から見た処世術は別の話としてあります。制度上は知られません。でも、自分から話せば当然知られます。そして受給の有無は、職場の人間関係において妬みや詮索の火種になり得ます。
...
A. 書けます。ただし順序が逆で、先に初診日の候補を絞る作業をしてください。お薬手帳、診察券、健康診断の記録、家計簿やカードの明細、転院時の紹介状の記憶が手がかりになります。紹介状(診療情報提供書)から初診日が認定された裁決もあります。詳しくは[初診日がわからないときの調べ方](/columns/shoshinbi-wakaranai)へ。

**Q. 働きながらの申請ですが、就労していると不利ですか?**
A. 「就労の事実」だけが伝わると「働ける=改善」と誤読されやすいのは事実です。ただし就労と受給は両立し得ます。欠勤・遅刻・早退の頻度、受けている配慮、障害者雇用か否か、業務内容の変更まで具体的に書き、実態を伝えてください。

**Q. 症状を少し重めに書いたほうが通りやすいですか?**
A. 逆です。診断書と食い違った時点で申立書全体の信頼が下がります。虚偽が過ぎれば、利息つきの返還請求や刑事罰の対象になり得ます。事実を頻度と具体例で書くことがいちばん強い書き方です。
...
A. 申請したこと自体が勤務先へ通知される仕組みはありません。申立書に勤務実態を書いても、会社へ共有されるものではないので、実態を正直に書いてください。一方で、「職場で自分から年金の話をしない」ことは、処世術としてよく勧められています。
...
- 誇張はしない。事実を頻度と具体例で書く
- 就労は「在籍の事実」でなく「実態」を書く。欠勤・配慮・辞めた理由まで。裁決でも見られているのは援助の中身
- 受診しなかった期間を空白にしない。理由と生活実態を書く
- 一気に書かず、メモを溜めてから4要素に整える

## 出典

- 日本年金機構「病歴・就労状況等申立書を提出するとき」(様式と記入例)・確認日 2026-09-03
...
※本記事は一般的な制度情報に基づくものです。受給や等級を保証するものではありません。正式な様式・記載要領は日本年金機構のホームページで、個別の判断は年金事務所・社会保険労務士でご確認ください。
