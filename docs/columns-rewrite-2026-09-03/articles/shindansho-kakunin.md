...
lead:
  - 受け取った診断書は、開封して確認してから出してよい書類です。提出後の修正は原則きかないので、確認が最後の砦です。
  - 見るのは7点。①傷病名・初診日が他の書類と一致 ②7項目の「できる」が家族の助けで成り立っていないか ③「程度」と7項目の平均が矛盾しないか ④就労欄に配慮や欠勤の実態があるか ⑤現症日が請求の種類に合っているか ⑥服薬しても残る症状 ⑦⑪⑫⑬が空欄でないか。
  - 7項目は「単身で生活するとしたら」で評価されます。同居家族の援助が手厚い人ほど軽く出やすい。令和6年度、精神の障害で不支給になった人の75.3%は「程度」が目安表の軽い側でした。
  - 軽いと感じたら、等級の書き換えではなく事実の追加提供を。事実の誤り・記載漏れは訂正を頼めます。提出前に必ずコピーを。
---
<!-- 変更: 結論の箱 / 文中太字を外し「①〜③」を h3 に / 道具(mitate)・誤解1枚・裁決2件 / 「専門家の間でも議論」の段落を原則に圧縮 / 「近年は更新でも追加の照会が増えている」を削除 / 誤字「確認しよいます」を修正 -->
...
封筒に「開封無効」と印字されていても、それは形式的な体裁であることが多いです。ただし個別に指示があるときは、先に医療機関か提出先へ確認します。
...
### ① 医師が見ているのは、あなたの最良の10分です

診察の日は、髪を整え、服を着替え、家を出て、電車に乗って、時間どおりに着いた日です。その日を作れなかった日は、そもそも診察室に持ち込まれません。医師が観察できるのは月に1〜2回、外出できる程度に調子を整えた日の、数分から十数分だけになります。

### ② 波の谷は記録に残りません

精神疾患の状態は日単位で浮き沈みします。よく眠れた朝もあれば、丸一日起きられない週もあります。診断書は現症日という1日を切り取って書くものなので、面ではなく点で評価されます。

### ③ 評価される7項目が、そもそも診察室では観察できません

食事、身辺の清潔保持、金銭管理と買い物、通院と服薬、他人との意思伝達と対人関係、身辺の安全保持と危機対応、社会性。どれも家での話です。記載要領でも、これらは本人や家族から聴き取って書く項目とされています。言わなければ、書かれません。

令和6年度の統計では、精神の障害で不支給になった人の75.3%が、診断書の「日常生活能力の程度」で目安表の軽い側にいました。だからこそ、提出前の確認が最後の砦になります。
...
- イ……その状態の具体的な記載
- ウ……日常生活状況。ここに「日常生活能力の判定」7項目と「日常生活能力の程度」5段階が入る
- エ……現症時の就労状況
- オ・カ……身体所見、臨床検査
- キ……福祉サービスの利用状況
...
電卓を叩く代わりに、診断書の7項目と程度をそのまま入れて確かめられる道具を用意しました。
...
社会保険審査会の裁決から、診断書の中身の整合が問われた実例です。原文は厚生労働省の公開資料で確認しています。

**網膜剥離・緑内障・新規裁定(令和4〜5年、r04_05-06_12)** — 視力・視野の検査結果と病態が整合しないとして、診断書の数値をそのまま障害の状態とすることはできないと判断され、原処分が維持されました。「診断書に書いてあれば通る」のではなく、書類の中の整合まで見られる、という例です。精神の障害でいえば、7項目と「程度」の矛盾がこれに当たります。

**副腎白質ジストロフィー・更新(令和6年、r06-03_05)** — 進行性の病気なのに、前回の診断書から全項目が「改善」となっている矛盾を審査会が指摘し、診断書は正確性に欠けるとして減額処分が取り消されました。前回の控えと並べて比べる、という下の「更新」の確認法は、この裁決の考え方そのものです。

→ ほかの実例も読む(/jitsurei)

## 例: アキさんの「答え合わせ」

チェックリストを、具体例で一度通してみます。32歳、うつ病、母と同居(この記事のための架空の例です)。受け取った診断書はこうなっていました。
...
- 提出前に必ずコピー。更新の比較にも、不支給だったときの検証にも、控えがないと始まらない。裁決でも前回との整合が見られている

## 出典

- 日本年金機構「診断書(精神の障害用)様式第120号の4」および記載要領・確認日 2026-09-03
- 厚生労働省「精神の障害に係る等級判定ガイドライン」(目安表、総合評価の考慮事項)・確認日 2026-09-03
- 厚生労働省「国民年金・厚生年金保険 障害認定基準」(平衡機能・聴覚・肢体の認定要領)・確認日 2026-09-03
