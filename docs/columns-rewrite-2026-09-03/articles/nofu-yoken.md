...
lead:
  - 納付要件は2本立てで、どちらか片方を満たせば足ります。①初診日の前々月までの加入期間の3分の2以上が納付済み・免除、または ②初診日の前々月までの直近1年間に未納がない(65歳未満)。多くの人を救うのは②です。
  - 判定は「初診日の前日」で固定です。初診日のあとにまとめて納めても、免除申請をしても、判定は変わりません。払えないときは未納で放置せず、免除・猶予を申請しておくのが唯一の事前防御です。
  - 免除・学生納付特例・納付猶予は未納ではありません。「未納だらけ」と思い込んでいた人が、記録を出したら要件を満たしていた、はよくあります。年金事務所で「被保険者記録照会回答票」を出してもらってください。
  - 初診日の候補が複数あるなら、候補ごとに納付要件を見てもらいます。満たさなくても、初診日の見直し・社会的治癒・20歳前傷病・特別障害給付金・記録訂正の道があります。
---
<!-- 変更: 結論の箱 / 文中太字を外し「①②」「①〜⑤」を h3 に / 道具(madoguchi)・誤解2枚・裁決3件(納付要件が争点) / 20歳前の所得制限を令和8年度の額と10月改定に / 「審議会の資料では」を削除 -->
...
→ 「昔、保険料を払っていなかったから、一生もらえない」は誤解です(/gokai/mukashi-minou)
...
## 例: 記録を出したら、話が2回ひっくり返った

具体例で通しておきます(この記事のための架空の例です)。30代前半、うつ病。20代の前半にフリーターをしていた時期があり、その頃の国民年金はほとんど払っていないという記憶がありました。「未納だらけだから、自分は対象外だ」と3年ほど請求を見送っていました。
...
そして納付要件が免除される代わりに、制約がつきます。20歳前傷病の障害基礎年金には所得制限があります(令和8年度、扶養親族がいない場合)。

- 前年所得が3,761,000円以下……全額支給
- 3,761,000円超〜4,794,000円以下……2分の1支給停止
- 4,794,000円超……全額支給停止

令和8年10月分からは、この基準額が3,858,000円と4,918,000円に改定されます。扶養親族がいれば基準額は加算され、支給停止の期間は10月から翌年9月までの1年単位で動きます。働き始めてしばらくしてから支給停止の通知が届いて驚く、というのがよくある流れです。

このほか、20歳前傷病には海外居住中の全額支給停止、刑事施設等に収容され有罪が確定した場合の全額支給停止、労災年金との調整といった制約もあります。詳しくは[20歳前傷病の障害基礎年金](/columns/hatachi-mae)へ。
...
社会保険審査会の裁決から、納付要件が争点になった実例です。原文は厚生労働省の公開資料で確認しています。当サイトが確認した裁決91件のうち、納付要件が争点になったものは10件です。

**妄想型統合失調症・障害認定日請求(平成30〜令和元年、h30_r01-16_03)** — 20歳になった直後、被保険者期間2か月に対して12か月分を速やかに納付した経過などから、1か月分だけ未納でも実質的に納付要件を満たすと評価し、原処分が取り消されました。「1か月足りない」で機械的に切られなかった例です。

**アテローム血栓性脳梗塞・新規裁定(令和7年、r07-03_08)** — 事業所が厚生年金の適用届出をする前の期間について、保険料の徴収権と時効の解釈により納付済期間への算入を認め、納付要件を満たすと判断されました。記録の是正が納付要件に効いた例で、下の「⑤ 記録訂正」に当たります。

**糖尿病・高血圧・事後重症請求(平成28〜29年、h28_29-07_16)** — 高血圧については、申し立てた初診日の前日に納付要件を満たしていないとして、原処分が維持されました。初診日ごとに納付要件が別々に判定される、という話の実例です。
...
窓口で頼むべきものには名前があります。「被保険者記録照会回答票」です。これは納付済・免除・未納・合算対象期間といった区分を、月ごとに明示した帳票になります。本人確認書類と基礎年金番号がわかるものを持って行けば出してもらえる(代理人の場合は所定の委任状が必要)。管轄の年金事務所と予約の電話番号は、お住まいの市区町村から出せます。
...
症状が安定して特段の治療が必要なく、通常の社会生活を送れていた期間が一定以上続いていた場合、その後の再受診日を新しい初診日として扱える考え方です。決まった年数はなく、認められなかった裁決も多いので、過度に期待せず資料で組み立てます。
...
→ 「制度に入っていなかった時代だから、もう何もない」は誤解です(/gokai/munenkin-owari)

### ⑤ 記録訂正

本当は3号だったのに1号未納として記録されている、事業主が厚生年金の資格取得届を出していなかった——といったケースを疑い、記録訂正を請求します。訂正が通れば未納が消えます。

なお、厚生年金の資格取得届が初診日以後に提出された場合、届出の前々月まで遡って2年間が当初から納付済期間として扱われます。これは「後出し」ではなく記録の是正なので、納付要件に効きます(上の裁決 r07-03_08 も、この考え方で救われた例です)。
...
- 判定は初診日の前日時点。後から納めても、後から免除申請しても、間に合わない
...
- 満たしていなくても、初診日の見直し・社会的治癒・20歳前傷病・特別障害給付金・記録訂正という道がある。裁決にも、1か月の未納や事業所の届出漏れで救われた例がある

## 出典

- 国民年金法第30条、厚生年金保険法第47条(保険料納付要件)、国民年金法等の一部を改正する法律附則(直近1年要件の特例)・確認日 2026-09-03
- 日本年金機構「障害年金の保険料納付要件」「20歳前の傷病による障害基礎年金にかかる支給制限等」(令和8年度の所得基準額)・確認日 2026-09-03
- 日本年金機構「特別障害給付金制度」・確認日 2026-09-03
- 当サイト 裁決事例集(91件、納付要件が争点10件)・確認日 2026-09-02
