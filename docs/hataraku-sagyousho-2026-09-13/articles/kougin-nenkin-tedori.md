...
→ 工賃と年金の合算を、自分の数字で計算する(/dougu/kougin)
...
### 手当
重い障害で常に介護が要る人には特別障害者手当(月約2.9万円)があります。自治体独自の手当や、医療費の助成(マル障など)は、地域で大きく違います。市の障害福祉課で「私が使える手当を、全部教えてください」と聞くのが早いです。
...
→ 生活保護と障害年金(/joukyou/seikatsu-hogo)
...
1. 平均工賃の月額(去年の実績)と、時給にするといくらか
2. 工賃の決め方(時給か、出来高か、作業で違うか)
3. 作業日数と時間の選び方(週1日から通えるか)
4. 在宅で作業できるか。その場合の工賃
5. 利用料が、自分の世帯だといくらか
6. 交通費の助成や送迎があるか
7. 昼食の費用
8. 工賃の支払日と方法(手渡しか、振込か)
...
→ A型事業所が閉鎖したとき(/jukyuugo/a-gata-heisa)
...
**工賃の高い事業所を選ぶ。** 事業所ごとの平均工賃は公表されていて、月1万円台から8万円台まで幅があります。見学で「平均工賃」「作業日数」「在宅の可否」を聞いてください。

**年金の等級を落とさない。** 作業所に通えていることは、審査で「助けのある場所で活動できている」と読まれます。更新の診断書に、通所日数と、作業中の声かけ・見守り・休憩の配慮を書いてもらってください。
