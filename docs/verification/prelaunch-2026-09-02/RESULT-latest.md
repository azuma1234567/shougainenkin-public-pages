...
| # | 判定 | 項目 | 件数 |
|---|---|---|---|
| C-1 | × | sitemap.xml: 全公開ページが入り、未公開ページが入っていない | 収録 167、リンクはあるが未収録 1、予約slugの混入 0、200以外 0 |
...
| C-5 | ○ | 旧URLからのリダイレクトが必要な変更がない | 公開前URL 76 件のうち200以外 0<br>※main ブランチの sitemap 静的ページ + 記事URL |
