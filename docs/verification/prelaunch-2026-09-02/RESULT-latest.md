...
origin: http://localhost:3200 / ページ数: 161 / 基準: git main
...
| A-3 | ○ | 404が出るリンクがゼロ | リンク先 161 件を検査、破損 0 |
| A-4 | ○ | 未公開ページへのリンクがゼロ | 予約slug 4 件へのリンク 0 |
| A-5 | ○ | noindex が残っていない | noindex 0 / 161 |
| A-6 | ○ | canonical が自分自身を指している | 自己参照 161 / 161 |
...
| # | 判定 | 項目 | 件数 |
|---|---|---|---|
| B-1 | ○ | 孤立ページがゼロ(本文からの内部リンクが最低1本) | 孤立 0 / 161(除外 5)<br>※ヘッダー・フッターのリンクは数えない。法務・案内ページ(about/privacy/terms/quality/support)はフッターのみで可 |
...
| # | 判定 | 項目 | 件数 |
|---|---|---|---|
| C-1 | ○ | sitemap.xml: 全公開ページが入り、未公開ページが入っていない | 収録 161、リンクはあるが未収録 0、予約slugの混入 0、200以外 0 |
| C-2 | 手動 | sitemapの分割 | 対象外(161ページ・単一 sitemap.xml で十分。50,000 URL 超で再検討)<br>※Google の分割要件は 50,000 URL または 50MB。2026-09-02 に対象外とした |
