// §2 の 2〜8。node --import ./scripts/lib/ts-alias.mjs docs/verification/sharoushi-kawaranai-koto-2026-09-07/check.mjs http://127.0.0.1:3000
import { chromium } from "playwright";
import { parse } from "node-html-parser";
import { writeFileSync } from "node:fs";
import { faqs, lead } from "../../../content/columns/sharoushi-kawaranai-koto.ts";
const origin = process.argv[2] ?? "http://127.0.0.1:3000";
const dir = "docs/verification/sharoushi-kawaranai-koto-2026-09-07";
const out = []; const say = (s) => { out.push(s); console.log(s); };
const SLUG = "sharoushi-kawaranai-koto", URL_ = `${origin}/columns/${SLUG}`;
...
for (const h of ["/erabu/jibun-ka-irai", "/erabu/irai-subeki-case", "/erabu/erabikata", "/erabu/hiyou-souba"]) {
