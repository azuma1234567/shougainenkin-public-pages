    ...
    <footer className="site-footer">
      <div className="site-footer-inner">
        <nav className="footer-links" aria-label="フッターメニュー">
          ...
          <section><h2>このサイトについて</h2><Link href="/about">このサイトについて</Link><Link href="/quality">情報の作り方</Link><Link href="/support">お問い合わせ</Link><Link href="/privacy">プライバシーポリシー</Link><Link href="/terms">利用規約</Link><Link href="/ads">広告掲載について</Link><Link href="/app">無料iPhoneアプリ</Link><Link href="/app/terms">アプリの利用規約・プライバシーポリシー</Link></section>
        </nav>
