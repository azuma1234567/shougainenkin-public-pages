...
import { HAS_ACTIVE_ADS, SHOW_LISTINGS } from "@/lib/ads";
    ...
    <footer className="site-footer">
      <div className="site-footer-inner">
        <nav className="footer-links" aria-label="フッターメニュー">
          <section><h2>病気・状況・困りごと別</h2><Link href="/byoki">病気別</Link><Link href="/joukyou">状況別</Link><Link href="/nayami">困りごと別</Link><Link href="/dougu/mitate">等級の目安をしらべる</Link><Link href="/erabu">自分でやるか、頼むか</Link>{SHOW_LISTINGS && <Link href="/sharoushi">社労士を探す</Link>}</section>
          ...
          <section><h2>このサイトについて</h2><Link href="/about">運営者情報</Link><Link href="/quality">情報の作り方</Link><Link href="/support">お問い合わせ</Link><Link href="/privacy">プライバシーポリシー</Link><Link href="/terms">利用規約</Link><Link href="/ads">広告掲載について</Link><Link href="/app">無料iPhoneアプリ</Link><Link href="/app/terms">アプリの利用規約・プライバシーポリシー</Link></section>
        </nav>
