  ...
  return (
    <>
      ...
      <p>
        ...
        「{SITE_NAME}」も開発しています。記録は端末の中に保存され、AI機能を使うときだけ、
        選んだ文章が処理のために送信されます。このウェブサイトとは別に、
        <Link href="/app/terms">iPhoneアプリ版の利用規約</Link>と
        <Link href="/app/privacy">iPhoneアプリ版のプライバシーポリシー</Link>を定めています。
      </p>
