...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "書けない日は書かなくて大丈夫です。書けた日の1〜2行に意味があります。また、家族が代わりに書いた「見た様子」の記録にも価値があります。家族・支援者による第三者記述は、書類の整合性の裏付けになります。",
  },
  {
    question: "診察で元気にふるまってしまうのは、治すべき癖ですか?",
    answer:
      "癖というより、外出できる状態を整えて診察に行く以上、避けにくい構造です。状態は日々大きく波打つのに、診察はその一瞬しか切り取れません。だからこそ、波の全体を紙で渡す方法に意味があります。",
  },
  {
