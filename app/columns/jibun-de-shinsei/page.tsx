...
// このページには「よくある質問」セクションがないため、FAQPageの構造化データは
// 出していない。質問・回答はページ上にそのまま表示されている必要があるため。
...
export default function Page() {
  return (
    <article>
      ...
      <h2>社労士に依頼する場合</h2>
      <p>障害年金を専門に扱う社労士は、書類の収集・作成・提出の代行や、医師への診断書依頼の際の資料づくりなどを支援してくれます。</p>
      <p>費用は事務所によって異なりますが、着手金(無料〜数万円程度)と、受給が決まった場合の成功報酬(年金額の数か月分などを基準とする例が多い)という料金体系が一般的です。契約前に、料金体系と、不支給だった場合の費用を必ず確認しましょう。</p>
