...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "等級を指定する依頼はできません。できるのは、伝わっていなかった生活の事実を追加で伝えることです。日付の誤記や記載漏れといった事実の誤りであれば訂正を依頼できますが、評価そのものの書き換えは医師の医学的判断に委ねてください。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "作成料は医療機関ごとに異なります。事実の訂正にはあらためて料金がかからないことが多い一方、新しく書き直す場合は費用が発生する可能性があります。依頼前に医療機関へ確認してください。",
  },
  {
