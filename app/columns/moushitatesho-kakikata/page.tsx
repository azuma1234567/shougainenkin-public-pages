...
const faqs = [
  {
    ...
    answer:
      "書けます。ただし順序が逆で、先に初診日の候補を絞る作業をしてください。お薬手帳、診察券、健康診断の記録、家計簿やカードの明細、転院時の紹介状の記憶が手がかりになります。紹介状などの医療機関間の書類で初診日が確定するケースは多くあります。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "申請したこと自体が勤務先へ通知される仕組みはありません。申立書に勤務実態を書いても、会社へ共有されるものではないので、実態を正直に書いてください。一方で、「職場で自分から年金の話をしない」ことは、処世術としてよく勧められています。",
  },
  {
