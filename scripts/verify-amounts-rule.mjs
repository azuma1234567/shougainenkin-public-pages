...
for (const value of ["29,590円", "45,480円", "545,760円", "56,850円", "682,200円", "16,100円", "56,800円", "37,830円"]) {
...
assert.match(explain("16,560円", ""), /^制度の額: childDisabilityWelfareAllowanceMonthly\(.*令和8年度/);
assert.match(explain("58,450円", ""), /^制度の額: specialChildRearingAllowanceGrade1Monthly\(.*令和8年度/);
assert.match(explain("38,930円", ""), /^制度の額: specialChildRearingAllowanceGrade2Monthly\(.*令和8年度/);
