...
const names = ["byoki-tougou", "byoki-chiteki", "byoki-tenkan", "byoki-hattatsu", "byoki-tekiou-fuan", "erabu-jibun-ka-irai", "joukyou-hatachi-mae", "joukyou-hatarakinagara", "joukyou-hitorigurashi", "joukyou-shoubyou-teatekin-kara", "nayami-koushin", "nayami-shikyuu-teishi", "nayami-shindansho-komatta", "nayami-shoshinbi-karute", "nayami-sokyuu", "okane-ikura"];
...
if (Object.keys(content).length !== 16) failures.push("本文ページ数が16ではありません");
if (failures.length) { console.error(failures.join("\n")); process.exit(1); }
console.log(`OK: 本文16ページ。本文一致、見出し/FAQ一致、非公開語0、予約URLリンク0。`);
